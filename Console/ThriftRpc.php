...
class ThriftRpc extends Command
{
    ...
    public function handle()
    {
        ...
        //$loader->registerNamespace('Queryyetsimple\Protocol\Thrift', __DIR__.'/../../Protocol/Thrift');
        //$loader->registerDefinition('Queryyetsimple\Protocol\Thrift',  __DIR__.'/../../Protocol/Thrift');
        //$loader->register();
        
  
        $service = new \Queryyetsimple\Protocol\Thrift\ThriftHandler();
        $processor = new \Queryyetsimple\Protocol\Thrift\ThriftProcessor($service);
        $socket_tranport = new TServerSocket('0.0.0.0', 8099);
        $out_factory = $in_factory = new \Queryyetsimple\Protocol\Thrift\TFramedTransportFactory();
        $out_protocol = $in_protocol = new \Thrift\Factory\TBinaryProtocolFactory();

        $server = new \Queryyetsimple\Protocol\ThriftServer($processor, $socket_tranport, $in_factory, $out_factory, $in_protocol, $out_protocol);
        $server->serve();
