...
class HavingTest extends TestCase
{
    ...
    public function testHavingBetween(): void
    {
        ...
        $sql = <<<'eot'
            [
                "SELECT `test_query`.`name` AS `id`,`test_query`.`tname` AS `value` FROM `test_query` GROUP BY `test_query`.`name` HAVING `test_query`.`name` BETWEEN :__test_query__name__0 AND :__test_query__name__1 AND `test_query`.`name` BETWEEN :__test_query__name__1__0 AND :__test_query__name__1__1",
                {
                    ...
                    "__test_query__name__1__0": [
                        1,
                        1
                    ],
                    "__test_query__name__1__1": [
                        100,
                        1
                    ]
                },
        ...
        $sql = <<<'eot'
            [
                "SELECT `test_query`.`name` AS `id`,`test_query`.`tname` AS `value` FROM `test_query` GROUP BY `test_query`.`name` HAVING `test_query`.`name` BETWEEN :__test_query__name__0 AND :__test_query__name__1 AND `test_query`.`tname` BETWEEN :__test_query__tname__0 AND :__test_query__tname__1",
                {
                    "__test_query__name__0": [
                        1,
                        1
                    ...
                    "__test_query__tname__0": [
                        5,
                        1
                    ],
                    "__test_query__tname__1": [
                        22,
                        1
                    ]
                },
    ...
    public function testHavingNotBetween(): void
    {
        ...
        $sql = <<<'eot'
            [
                "SELECT `test_query`.* FROM `test_query` GROUP BY `test_query`.`name` HAVING `test_query`.`id` NOT BETWEEN :__test_query__id__0 AND :__test_query__id__1 AND `test_query`.`id` NOT BETWEEN :__test_query__id__1__0 AND :__test_query__id__1__1",
                {
                    "__test_query__id__0": [
                        1,
                        1
    ...
    public function testHavingIn(): void
    {
        ...
        $sql = <<<'eot'
            [
                "SELECT `test_query`.* FROM `test_query` GROUP BY `test_query`.`name` HAVING `test_query`.`id` IN (:__test_query__id__0,:__test_query__id__1) AND `test_query`.`num` IN (:__test_query__num__0,:__test_query__num__1)",
                {
                    "__test_query__id__0": [
                        2,
                        1
                    ...
                    "__test_query__num__0": [
                        2,
                        1
                    ],
                    "__test_query__num__1": [
                        50,
                        1
                    ]
                },
    ...
    public function testHavingNotIn(): void
    {
        ...
        $sql = <<<'eot'
            [
                "SELECT `test_query`.* FROM `test_query` GROUP BY `test_query`.`name` HAVING `test_query`.`id` NOT IN (:__test_query__id__0,:__test_query__id__1) AND `test_query`.`num` NOT IN (:__test_query__num__0,:__test_query__num__1)",
                {
                    "__test_query__id__0": [
                        2,
                        1
    ...
    public function testHavingBetweenArrayItemIsExpression(): void
    {
        ...
        $sql = <<<'eot'
            [
                "SELECT `test_query`.* FROM `test_query` GROUP BY `test_query`.`name` HAVING `test_query`.`id` BETWEEN (SELECT 1) AND :__test_query__id__1",
                {
                    "__test_query__id__1": [
                        100,
                        1
    ...
    public function testHavingInArrayItemIsExpression(): void
    {
        ...
        $sql = <<<'eot'
            [
                "SELECT `test_query`.* FROM `test_query` GROUP BY `test_query`.`name` HAVING `test_query`.`id` IN ((SELECT 1),:__test_query__id__1)",
                {
                    "__test_query__id__1": [
                        100,
                        1
