...
class EntityTest extends TestCase
{
    ...
    public function testUpdateWithVersion(): void
    {
        ...
        $this->assertSame('SQL: [213] UPDATE `test_version` SET `test_version`.`name` = :name,`test_version`.`version` = `test_version`.`version`+1 WHERE `test_version`.`id` = :__test_version__id AND `test_version`.`version` = :__test_version__version | Params:  3 | Key: Name: [5] :name | paramno=0 | name=[5] ":name" | is_param=1 | param_type=2 | Key: Name: [19] :__test_version__id | paramno=1 | name=[19] ":__test_version__id" | is_param=1 | param_type=1 | Key: Name: [24] :__test_version__version | paramno=2 | name=[24] ":__test_version__version" | is_param=1 | param_type=1 (UPDATE `test_version` SET `test_version`.`name` = \'aniu\',`test_version`.`version` = `test_version`.`version`+1 WHERE `test_version`.`id` = 1 AND `test_version`.`version` = 0)', $testVersion->select()->getLastSql());

        $testVersion->name = 'hello';
        $this->assertSame(1, $testVersion->update()->flush());
        $this->assertSame('SQL: [213] UPDATE `test_version` SET `test_version`.`name` = :name,`test_version`.`version` = `test_version`.`version`+1 WHERE `test_version`.`id` = :__test_version__id AND `test_version`.`version` = :__test_version__version | Params:  3 | Key: Name: [5] :name | paramno=0 | name=[5] ":name" | is_param=1 | param_type=2 | Key: Name: [19] :__test_version__id | paramno=1 | name=[19] ":__test_version__id" | is_param=1 | param_type=1 | Key: Name: [24] :__test_version__version | paramno=2 | name=[24] ":__test_version__version" | is_param=1 | param_type=1 (UPDATE `test_version` SET `test_version`.`name` = \'hello\',`test_version`.`version` = `test_version`.`version`+1 WHERE `test_version`.`id` = 1 AND `test_version`.`version` = 1)', $testVersion->select()->getLastSql());
    }
