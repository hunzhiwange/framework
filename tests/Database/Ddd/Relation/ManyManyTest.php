...
class ManyManyTest extends TestCase
{
    ...
    public function testSoftDeleted(): void
    {
        ...
        $sql = <<<'eot'
            SQL: [500] SELECT `role_soft_deleted`.*,`user_role_soft_deleted`.`role_id` AS `middle_role_id`,`user_role_soft_deleted`.`user_id` AS `middle_user_id` FROM `role_soft_deleted` INNER JOIN `user_role_soft_deleted` ON `user_role_soft_deleted`.`role_id` = `role_soft_deleted`.`id` AND `user_role_soft_deleted`.`delete_at` = :__user_role_soft_deleted__delete_at WHERE `role_soft_deleted`.`delete_at` = :__role_soft_deleted__delete_at AND `user_role_soft_deleted`.`user_id` IN (:__user_role_soft_deleted__user_id__in0) | Params:  3 | Key: Name: [36] :__user_role_soft_deleted__delete_at | paramno=0 | name=[36] ":__user_role_soft_deleted__delete_at" | is_param=1 | param_type=1 | Key: Name: [31] :__role_soft_deleted__delete_at | paramno=1 | name=[31] ":__role_soft_deleted__delete_at" | is_param=1 | param_type=1 | Key: Name: [39] :__user_role_soft_deleted__user_id__in0 | paramno=2 | name=[39] ":__user_role_soft_deleted__user_id__in0" | is_param=1 | param_type=1 (SELECT `role_soft_deleted`.*,`user_role_soft_deleted`.`role_id` AS `middle_role_id`,`user_role_soft_deleted`.`user_id` AS `middle_user_id` FROM `role_soft_deleted` INNER JOIN `user_role_soft_deleted` ON `user_role_soft_deleted`.`role_id` = `role_soft_deleted`.`id` AND `user_role_soft_deleted`.`delete_at` = 0 WHERE `role_soft_deleted`.`delete_at` = 0 AND `user_role_soft_deleted`.`user_id` IN (1))
            eot;
        $this->assertSame(
            $sql,
            User::select()->getLastSql(),
    ...
    public function testWithMiddleSoftDeletedAndMiddleEntityHasSoftDeleted(): void
    {
        ...
        $sql = <<<'eot'
            SQL: [420] SELECT `role_soft_deleted`.*,`user_role_soft_deleted`.`role_id` AS `middle_role_id`,`user_role_soft_deleted`.`user_id` AS `middle_user_id` FROM `role_soft_deleted` INNER JOIN `user_role_soft_deleted` ON `user_role_soft_deleted`.`role_id` = `role_soft_deleted`.`id` WHERE `role_soft_deleted`.`delete_at` = :__role_soft_deleted__delete_at AND `user_role_soft_deleted`.`user_id` IN (:__user_role_soft_deleted__user_id__in0) | Params:  2 | Key: Name: [31] :__role_soft_deleted__delete_at | paramno=0 | name=[31] ":__role_soft_deleted__delete_at" | is_param=1 | param_type=1 | Key: Name: [39] :__user_role_soft_deleted__user_id__in0 | paramno=1 | name=[39] ":__user_role_soft_deleted__user_id__in0" | is_param=1 | param_type=1 (SELECT `role_soft_deleted`.*,`user_role_soft_deleted`.`role_id` AS `middle_role_id`,`user_role_soft_deleted`.`user_id` AS `middle_user_id` FROM `role_soft_deleted` INNER JOIN `user_role_soft_deleted` ON `user_role_soft_deleted`.`role_id` = `role_soft_deleted`.`id` WHERE `role_soft_deleted`.`delete_at` = 0 AND `user_role_soft_deleted`.`user_id` IN (1))
            eot;
        $this->assertSame(
            $sql,
            User::select()->getLastSql(),
