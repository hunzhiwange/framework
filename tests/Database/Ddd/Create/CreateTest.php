...
class CreateTest extends TestCase
{
     ...
     *
     * ``` php
     * ".\Leevel\Leevel\Utils\Doc::getClassBody(\Tests\Database\Ddd\Entity\TestConstructPropWhiteEntity::class)."
     * ```
     *
     ...
     *
     * ``` php
     * ".\Leevel\Leevel\Utils\Doc::getClassBody(\Tests\Database\Ddd\Entity\TestConstructPropBlackEntity::class)."
     * ```
     *
