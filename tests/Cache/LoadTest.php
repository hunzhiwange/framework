...
class LoadTest extends TestCase
{
    ...
    public function testWithParams(): void
    {
        ...
        static::assertSame(['hello', 'world', 'foo', 'bar'], $result);
    }
    ...
    public function testClearCacheLoaded(): void
    {
        ...
        static::assertSame(['data' => 'data1'], $result);
        ...
        $result = $load->data([Test5::class]);
        static::assertSame(['data' => 'data2'], $result);
        ...
        $result = $load->data([Test5::class]);
        static::assertSame(['data' => 'data3'], $result);
    ...
    public function testCacheDataWasString(): void
    {
        ...
        static::assertSame('hello world for test6', $result);
    }
