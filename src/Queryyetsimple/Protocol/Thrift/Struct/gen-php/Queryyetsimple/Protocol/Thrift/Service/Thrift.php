...
interface ThriftIf {
   ...
   * 
   */
  public function call(\Queryyetsimple\Protocol\Thrift\Service\Request $request);
}


class ThriftClient implements \Queryyetsimple\Protocol\Thrift\Service\ThriftIf {
  ...
  public function send_call(\Queryyetsimple\Protocol\Thrift\Service\Request $request)
  {
    $args = new \Queryyetsimple\Protocol\Thrift\Service\Thrift_call_args();
  ...
  public function recv_call()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Queryyetsimple\Protocol\Thrift\Service\Thrift_call_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Queryyetsimple\Protocol\Thrift\Service\Thrift_call_result();
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::STRUCT) {
            $this->request = new \Queryyetsimple\Protocol\Thrift\Service\Request();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Queryyetsimple\Protocol\Thrift\Service\Response();
