 ...
 * @method static null|array|int             insert(array|string $data, array $bind = [], array|bool $replace = false, bool $flag = false)                              插入数据 insert (支持原生 SQL).
 * @method static null|array|int             insertAll(array $data, array $bind = [], array|bool $replace = false, bool $flag = false)                                  批量插入数据 insertAll.
