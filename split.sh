...
for REMOTE in auth cache collection console database debug di encryption event filesystem flow http i18n kernel log manager page pipeline level router seccode session stack support tree validate view
do
    echo ""
    echo ""
    echo "Split $REMOTE";
