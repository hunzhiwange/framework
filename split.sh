...
for REMOTE in auth cache config console database debug di encryption event filesystem http i18n kernel log page router server session support validate view
do
    echo ""
    echo ""
    echo "Split $REMOTE";
