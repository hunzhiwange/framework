...
for REMOTE in auth cache console database debug di encryption event filesystem http i18n kernel log manager page level router session support validate view
do
    echo ""
    echo ""
    echo "Split $REMOTE";
